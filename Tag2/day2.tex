...
\end{task}
\begin{task}
Sei $f(x)=x^2+24x+128$ und $g(x)=3x+2$. Ermitteln Sie die Funktionsvorschriften $(f \circ g)(x)$ und $(g \circ f)(x)$ sowie die Definitions- und Wertebereich von $f, g, f \circ g, g \circ f$, skizzieren Sie $g$ und geben sie zusätzlich den Bildbereich von $g$ an. 
\end{task}
\begin{task}
